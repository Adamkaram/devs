return {
  {
    ...
    keys = {
      ...
      {
        "<leader>f", function() require("theprimeagen.lazy.config.utils").telescope_git_or_file() end, desc = "Find Files (Root)",
      },
      {
    ...
    config = function()
      ...
      local icons = require("theprimeagen.lazy.config.icons")
